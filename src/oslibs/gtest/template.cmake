...
MACRO(dxm_config_template_init TEMPLATE_MODULE_NAME TEMPLATE_MODULE_DIRECTORY)
	...
	configure_file(
		${DXM_CMAKE_CURRENT_TEMPLATE_DIRECTORY}/src/lib_lib.cpp.in
	...
	# 3. 移除无用的文件及目录;
	#
	# dxm_file_rmdir(${TEMPLATE_MODULE_DIRECTORY}/${TEMPLATE_MODULE_NAME}/inc/lib)
	# dxm_file_rm(${TEMPLATE_MODULE_DIRECTORY}/${TEMPLATE_MODULE_NAME}/src/foo.cpp)
	dxm_file_rmdir(${TEMPLATE_MODULE_DIRECTORY}/inc/lib)
	dxm_file_rm(${TEMPLATE_MODULE_DIRECTORY}/src/foo.cpp)
	dxm_file_rm(${TEMPLATE_MODULE_DIRECTORY}/src/lib_lib.cpp)
	dxm_file_rm(${TEMPLATE_MODULE_DIRECTORY}/src/lib_lib.cpp.in)
ENDMACRO()
